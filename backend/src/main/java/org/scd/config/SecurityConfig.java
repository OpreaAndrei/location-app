...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/locations/create").hasAnyRole(ADMIN_ROLE, BASIC_USER_ROLE)
                .antMatchers("/locations/all").hasAnyRole(ADMIN_ROLE)
                .antMatchers("/locations/update/{id}").hasAnyRole(ADMIN_ROLE,BASIC_USER_ROLE)
                .antMatchers("/locations/delete/{id}").hasAnyRole(ADMIN_ROLE,BASIC_USER_ROLE)
                .antMatchers("/locations/id/{locationid}").hasAnyRole(ADMIN_ROLE,BASIC_USER_ROLE)
                .antMatchers("/locations/filter").hasAnyRole(ADMIN_ROLE)
                .anyRequest()
                .authenticated()
                .and()
                .formLogin().disable()
